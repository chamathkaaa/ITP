          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link " href="AdminView.html" role="tab" >
                              <i class="material-icons">dashboard</i> View Stock
                            </a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link active" href="AdminInsert.html" role="tab" >
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="address" size="45"
                			 placeholder="Shop Address" class="form-control" />
                      </div>
                    </div>
					<div class="form-group">
                      <div class="input-group">
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="BookID" size="45"
                			 placeholder="BookID" class="form-control" />
                      </div>
                    </div>
