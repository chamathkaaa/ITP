...
<body>
  ...
  <div class="page-header header-filter" data-parallax="true" style="  height:900px; background-image: url('assets/img/v.jpg')">
    <div class="container" >
    <div class="row">
     <h2>Welcome admin </h2> 
          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-16 col-md-18" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link active" href="AdminView.html" role="tab" >
                              <i class="material-icons">dashboard</i> Deliveries
                            </a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link " href="AdminInsert.html" role="tab" >
